        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <div class="d-flex align-items-center d-lg-none">
                    <a class="custom-btn btn" href="./entrar/login/login.php">
                        Login
                    </a>
                    <a class="custom-btn2 btn" href="./entrar/cadastro/cadastrar_usu.php">
                        Cadastro
                    </a>
                </div>
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="hero-text">
                                ...
                                <h3 class="mb-4 px-0">Eventos de 
                                    outro planeta.</h2>
                                <p class="mb-4 px-0"><a class="custom-btn3 btn custom-link" href="#section_2">Criar evento</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="card card-margin">
                                                    ...
                                                    <div class="card-body pt-0">
                                                        <div class="widget-49">
                                                            ...
                                                            <br>
                                                            <ol class="widget-49-meeting-points">
                                                                <li class="widget-49-meeting-item"><span>Preencha suas informações atenciosamente e selecione o botão de comprar</span></li>
                    ...
                    <div id="carouselExampleControls" class="carousel" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="card">
                                    <div class="img-wrapper"><img src="./images/imagine-dragons.jpeg" class="d-block w-100" alt="..."> </div>
                                    <div class="card-body">
                                        <h5 class="card-title">Imagine Dragons</h5>
                                        <p class="card-text">Ingressos indisponíveis.</p>
                                        <a href="#" class="custom-btn3">Saiba mais</a>
                                    </div>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="card">
                                    <div class="img-wrapper"><img src="./images/gpweek.jpeg" class="d-block w-100" alt="..."> </div>
                                    <div class="card-body">
                                        <h5 class="card-title">GPWeek</h5>
                                        <p class="card-text">Ingressos indisponíveis.</p>
                                        <a href="#" class="custom-btn3">Saiba mais</a>
                                    </div>
                                </div>
                            ...
                            <div class="carousel-item">
                                <div class="card">
                                    <div class="img-wrapper"><img src="./images/ah.jpg" class="d-block w-100" alt="..."> </div>
                                    <div class="card-body">
                                        <h5 class="card-title">The Weeknd</h5>
                                        <p class="card-text">Ingressos disponíveis.</p>
                                        <a href="#" class="custom-btn3">Saiba mais</a>
                                    </div>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="card">
                                    <div class="img-wrapper"><img src="./images/bsboys-mainban-v1.jpg" class="d-block w-100" alt="..."> </div>
                                    <div class="card-body">
                            ...
                            <div class="carousel-item">
                                <div class="card">
                                    <div class="img-wrapper"><img src="./images/rbd.jpg" class="d-block w-100" alt="..."> </div>
                                    <div class="card-body">
                            ...
                            <div class="carousel-item">
                                <div class="card">
                                    <div class="img-wrapper"><img src="./images/nct.png" class="d-block w-100" alt="..."> </div>
                                    <div class="card-body">
                            ...
                            <div class="carousel-item">
                                <div class="card">
                                    <div class="img-wrapper"><img src="./images/thumbs.jpeg" class="d-block w-100" alt="..."> </div>
                                    <div class="card-body">
                                        <h5 class="card-title">Paralamas do sucesso</h5>
                                        <p class="card-text">Ingressos indisponíveis.</p>
                                        <a href="#" class="custom-btn3">Saiba mais</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-2 col-12 pe-lg-0">
                                <div class="contact-info contact-info-border-start d-flex flex-column">
                                    ...
                                    <ul class="social-icon">
                                        ...
                                        <li class="social-icon-item"><a href="#" class="social-icon-link bi bi-envelope"></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
